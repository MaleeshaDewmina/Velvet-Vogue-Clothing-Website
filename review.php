        ...
        <table>
            ...
            <tbody>
                <?php while ($product = $orders->fetch_assoc()): ?>
                    <tr>
                        <td><img src="images/<?php echo htmlspecialchars($product['image']); ?>" class="product-img"></td>
                        <td><?php echo htmlspecialchars($product['name']); ?></td>
                        <td>Rs. <?php echo number_format($product['price'], 2); ?></td>
                        <td>
                            <button class="review-btn" 
                                onclick="showReviewForm(<?php echo $product['product_id']; ?>, '<?php echo htmlspecialchars($product['name']); ?>')">
                                Write Review
                            </button>
                        </td>
                    </tr>
